    ...
    return (
        <div className="bg-white rounded-3xl border shadow-xl p-8 m-16">
            ...
            <span className="pr-4">Price change</span>
                <span className={`font-bold text-${data?.market_data.price_change_24h ?? 0 > 0 ? 'green' : 'red'}-400`}>${data?.market_data.price_change_24h.toFixed(2)} ({data?.market_data.price_change_percentage_24h.toFixed(2)}%)</span>
            </div>
